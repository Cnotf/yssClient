...
/**
 * <p>saveHandPhotoData complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="saveHandPhotoData"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "savehandphotodata", propOrder = {
    "arg0"
})
public class SaveHandPhotoData {
     ...
     * 
     */
    public List<HandDateInfo> getArg0() {
        if (arg0 == null) {
